...
# TF1.4
g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I /home/t_hayashi/.pyenv/versions/2.7.14/lib/python2.7/site-packages/tensorflow/include -I /usr/local/cuda-8.0/include -I /home/t_hayashi/.pyenv/versions/2.7.14/lib/python2.7/site-packages/tensorflow/include/external/nsync/public -lcudart -L /usr/local/cuda-8.0/lib64/ -L/home/t_hayashi/.pyenv/versions/2.7.14/lib/python2.7/site-packages/tensorflow -ltensorflow_framework -O2 -D_GLIBCXX_USE_CXX11_ABI=0
