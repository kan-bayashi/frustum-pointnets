...
ROOT_DIR = os.getenv("PRJ_ROOT", os.path.dirname(BASE_DIR))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train', default=None, type=str,
                        help='list file of IDs for training.')
    parser.add_argument('--valid', default=None, type=str,
                        help='list file of IDs for validation.')
    parser.add_argument('--rgb_valid', default=None, type=str,
                        help='list file of IDs with 2d detection results for validation.')
    parser.add_argument('--write_dir', default="dump", type=str,
                        help='Directory to save pickle file.')
    ...
    if args.car_only:
        type_whitelist = ['Car']
        output_prefix = args.write_dir + '/frustum_caronly_'
    else:
        type_whitelist = ['Car', 'Pedestrian', 'Cyclist']
        output_prefix = args.write_dir + '/frustum_carpedcyc_'
    ...
    if args.gen_train:
        if args.train is None:
            train_list = os.path.join(BASE_DIR, 'image_sets/train.txt')
        else:
    ...
    if args.gen_val:
        if args.valid is None:
            valid_list = os.path.join(BASE_DIR, 'image_sets/val.txt')
        else:
    ...
    if args.gen_val_rgb_detection:
        if args.rgb_valid is None:
            rgb_valid_list = os.path.join(BASE_DIR, 'rgb_detections/rgb_detection_val.txt')
        else:
            rgb_valid_list = args.rgb_valid
